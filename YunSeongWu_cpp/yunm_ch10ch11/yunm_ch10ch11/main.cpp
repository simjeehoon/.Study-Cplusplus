...
int main(void)
{
	...
	std::cout << "윤성우 C++ Chapter 10, 11 문제" << std::endl;
	while (1)
	{
		std::cout << "[문제 입력 (ex.10-1-1, 10-3) (q입력시 종료)]" << std::endl;
		std::cout << "	입력 :";
		std::cin >> problem;
...
int Call_Function(char * problem)
{
	...
	/*********** 문제 목록 ***********/
	if (strcmp(problem, "10-1-1") == 0)
		return_value = yunm10_1_1();
	else if (strcmp(problem, "10-1-2") == 0)
		return_value = yunm10_1_2();
